...
<div class="blogPosts view large-9 medium-8 columns content">
    ...
    <table class="vertical-table">
        ...
        <tr>
            ...
            <td><?= $blogPost->has('user') ? $this->Html->link($blogPost->user->id, ['controller' => 'Users', 'action' => 'view', $blogPost->user->id]) : '' ?></td>
        </tr>
        <tr>
    ...
    <div class="row">
        <h4><?= __('Post Text') ?></h4>
        <?= $this->Text->autoParagraph(h($blogPost->post_text)); ?>
    </div>
</div>
